...
from diablorun_igt import loading_detection
...
if __name__ == "__main__":
    ...
    for test_image in test_images:
        ...
        is_loading = loading_detection.is_loading(image_rgb)

        if is_loading != test_image["is_loading"]:
            print(test_image["path"], "is_loading", is_loading,
                  "should be", test_image["is_loading"])
